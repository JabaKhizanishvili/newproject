                        ...
                        <form class="mr-0 p-0">
                            <table class="table mg-b-0 text-md-nowrap">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input class="form-control" type="text" name="parent_id" onchange="this.form.submit()"
                                               value="{{Request::get('parent_id')}}"
                                               class="validate {{$errors->has('parent_id') ? '' : 'valid'}}">
                                    </th>
                                    <th></th>
                                </tr>
                                ...
                                @if($data)
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            @endphp
                                            {{-- @dd(\App\Models\Menu::with('translations')->where("id",2)->get()->first()) --}}
                                            <td>
                                                {{$parent->name}}
                                            </td>
