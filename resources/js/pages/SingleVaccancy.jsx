...
{/* here hoes icons */}
        ...
        <div className="flex mt-4">
        {
                    ( vaccancy.vaccancylink1!= null ?
                        <a href={gfacebook.value} className="mr-2" target="_blank">
                    {/* <FaTwitter/> */}
                    <img src={fa} alt="" />
                    </a>
                    :
                ...
                }
                {
                    ( vaccancy.vaccancylink2!= null ?
                        <a href={ginstagram.value} className="mx-2" target="_blank">
                    {/* <FaTwitter/> */}
                ...
                }
                {
                    ( vaccancy.vaccancylink3!= null ?
                        <a href={glinkedin.value} className="mx-2" target="_blank">
                    {/* <FaTwitter/> */}
                    <img src={li} alt="li" />
                    </a>
                    :
