...
/**
 * @version		$Id: filteroutput.php 1 2011-07-13 05:09:23Z $
...
abstract class FilterOutput
{
    ...
    {
        $regex = 'href="([^"]*(&(amp;){0})[^"]*)*?"';
        return preg_replace_callback("#$regex#i", array('FilterOutput', '_ampReplaceCallback'), $input);
    }
