...
class XCacheStorageFile
{
	...
	function __construct( $options )
	{
		...
		$this->_root = PATH_BASE . DS . 'cache';
		$this->_application = 'Default';
		$this->_language = $langID ? $langID : 'Default';
		$this->_now = time();
	...
	function test()
	{
		...
		$root = $config->getValue( 'config.cache_path', PATH_BASE . DS . 'cache' );
