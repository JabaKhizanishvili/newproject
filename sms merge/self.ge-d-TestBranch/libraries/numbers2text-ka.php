...
/**
 * @version		$Id: numberska-GE.php 1 2010-12-27 06:22:08Z$
 * @package	Joomla.WSTools.WSLib
...
// strip excessive zero signs and spaces
        ...
        $ns = array_reverse(str_split($num));
        $n = array_chunk($ns, 3);
    ...
    function getTriplet($n)
    {
        ...
        switch($c)
        {
            ...
            case 3:
                ...
                return isset($this->de[$n[2]]) ? $this->de[$n[2]] : '' . ' ' . $this->_sep . $this->get2($n);
        }
        return $this->a[$n[0]];
    }

    public function get2($n)
    {
        switch($n[1])
        {
            case 1:
    ...
    public function getOtherTriplet($n, $count, $return)
    {
        $c = count($n);
        $k = intval(implode($n));
        if(empty($k))
