...
class Auth
{
	...
	{
		$this->_settings = new XSAMLSettings( );
	...
	public function processResponse( $requestId = null )
	{
		...
		$SAMLResponse = Request::getVar( 'SAMLResponse' );
		if ( $SAMLResponse )
		{
		...
		else
		{
			...
			throw new XSAMLError( 'SAML Response not found, Only supported HTTP_POST Binding',
											XSAMLError::SAML_RESPONSE_NOT_FOUND
			);
		}
	...
	public function processSLO( $keepLocalSession = false, $requestId = null, $retrieveParametersFromServer = false, $cbDeleteSession = null, $stay = false )
	{
		$this->_errors = array();
		$this->_lastError = $this->_lastErrorException = null;
		$SAMLResponse = Request::getVar( 'SAMLResponse', null, 'get' );
		$SAMLRequest = Request::getVar( 'SAMLRequest', null, 'get' );
		$RelayState = Request::getVar( 'RelayState', null, 'get' );
		if ( $SAMLResponse )
		{
			$logoutResponse = new LogoutResponse( $this->_settings, $SAMLResponse );
		...
		else if ( isset( $SAMLRequest ) )
		{
			$logoutRequest = new LogoutRequest( $this->_settings, $SAMLRequest );
		...
		else
		{
			...
			throw new XSAMLError(
											...
											XSAMLError::SAML_LOGOUTMESSAGE_NOT_FOUND
			);
		}
	...
	public function redirectTo( $url = '', array $parameters = array(), $stay = false )
	{
		...
		$RelayState = Request::getVar( 'RelayState' );
	...
	public function logout( $returnTo = null, array $parameters = array(), $nameId = null, $sessionIndex = null, $stay = false, $nameIdFormat = null, $nameIdNameQualifier = null, $nameIdSPNameQualifier = null )
	{
		...
		if ( empty( $sloUrl ) )
		{
			throw new XSAMLError(
											...
											XSAMLError::SAML_SINGLE_LOGOUT_NOT_SUPPORTED
			);
		}
	...
	private function buildMessageSignature( $samlMessage, $relayState, $signAlgorithm = XMLSecurityKey::RSA_SHA256, $type = "SAMLRequest" )
	{
		...
		if ( empty( $key ) )
		{
			...
			throw new XSAMLError( $errorMsg, XSAMLError::PRIVATE_KEY_NOT_FOUND );
		}
