...
class XCurlCaseInsensitiveArray implements \ArrayAccess, \Countable, \Iterator
{
	/**
	 ...
	 *
	 * @return XCurlCaseInsensitiveArray
	 *
	 * @access public
	 */
	...
	public function offsetSet( $offset, $value )
	{
		...
		{
			$offsetlower = mb_strtolower( $offset );
	...
	{
		return (bool) array_key_exists( mb_strtolower( $offset ), $this->data );
