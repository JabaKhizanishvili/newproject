<?php
/**
 * @version		$Id: DayCount.php 1 2011-07-13 05:09:23Z $
...
/**
 * Renders a DayCount element
 *
 * @package 	WSCMS.Framework
 * @subpackage		Parameter
 * @since		1.5
 */
class JElementDayCount extends JElement
{
	/**
	 * Element name
	 *
	...
	public function fetchElement( $name, $valueIN, $node, $control_name )
	{
		...
		$Html .= '<span class="input-group-addon">'
						. '<a class="btn btn-link  btn-xs" type="button" onclick="LoadCalculateDiff(\'#paramsSTART_DATE input\', \'#paramsEND_DATE input\', \'#' . $control_name . $name . '\');">' . Text::_( 'Calculate' ) . '</a>'
						. '</span>'
						. '</div>'
		;
