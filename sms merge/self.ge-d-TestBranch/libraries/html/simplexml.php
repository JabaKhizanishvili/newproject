...
/**
 * @version		$Id: simplexml.php 1 2011-07-13 05:09:23Z $
...
//If so, set the document as the current tag
            $classname = get_class($this) . 'Elements';
...
//Set the level
     ...
     */
    public function attributes($attribute = null, $default = null)
    {
        if(!isset($attribute))
        {
            return $default;
