	...
	<form action="?option=<?php echo $this->_option_edit; ?>" method="post" class="form-horizontal" name="fform" id="fform">
		<div class="row">
			<div class="col-md-6">
                ...
                $exist = C::_('ID', $this->data, 0);

                if($exist) {
                    echo HTML::renderParams( $params, dirname( __FILE__ ) . DS . 'default-edit.xml' );
                } else {
			...
			<div class="col-md-6">
                ...
                if($exist) {
                    echo HTML::renderParams( $params, dirname( __FILE__ ) . DS . 'default-edit.xml', 'params', 'details' );
                } else {
