...
<div class="page_title">
	...
	<div class="toolbar">
		...
		Helper::getToolbar( 'Continue', $this->_option_edit, 'continue', 1 );
		...
		if ( Helper::CheckTaskPermision( 'admin', $this->_option ) )
		{
			...
			Helper::getToolbar( 'additional_status', $this->_option_edit, 'additional_status', 1, 1 );
...
<div class="page_content">
	<form action="" method="get" name="fform" id="fform">
		...
		{
			echo HTML::renderFilters( '', dirname( __FILE__ ) . DS . 'default_chief.xml', $config );
			echo HTML::renderGrid( $this->data->items, dirname( __FILE__ ) . DS . 'default_chief.xml', $config );
		}
		?>
