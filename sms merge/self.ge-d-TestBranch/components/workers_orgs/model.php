...
class Workers_orgsModel extends Model
{
	/**
	 * 
	 * @return type
	...
	function getList()
	{
		...
		$Return->graphtype = (int) Request::getState( $this->_space, 'graphtype', '-1' );
		$Return->graphgroup = (int) Request::getState( $this->_space, 'graphgroup', '-1' );
		...
		if ( $Return->graphgroup > -1 )
		{
			$where[] = ' t.graphgroup= ' . DB::Quote( $Return->graphgroup );
		}
