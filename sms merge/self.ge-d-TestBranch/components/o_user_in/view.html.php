...
class o_user_inView extends View
{
	protected $_option = 'o_user_in';
	protected $_option_edit = 'o_user_in';

	function display( $tmpl = null )
	{
		/* @var $model o_user_inModel */
		...
		switch ( $task )
		{
			...
			case 'approve':
				...
				if ( $status )
				{
					XError::setMessage( 'Private Time Request(s) Approved!' );
					Users::Redirect( $link );
				}
				else
				{
					XError::setError( 'Private Time Request(s) Not Approved!' );
					Users::Redirect( $link );
				}
				break;
