...
$Config = Helper::getConfig( 'autoovertime_on' );
if ( !$Config )
{
	die( 'Run Overtimes Disabled By Config!' );
}
$MinHour = floatval( trim( Helper::getConfig( 'autoovertime_min_hour' ) ) );
$MaxHour = floatval( trim( Helper::getConfig( 'autoovertime_max_hour' ) ) );
$AfterDay = intval( trim( Helper::getConfig( 'autoovertime_after_day' ) ) );
$AlertTemplate = trim( Helper::getConfig( 'autoovertime_alert' ) );
