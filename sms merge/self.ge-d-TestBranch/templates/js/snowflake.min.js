...
function SNOW(state)
{
   if(state == 'gvn')
  {
     START_SNOW(frames = 15, count = 20, lifetime = 1, maxSpeed = 4, maxSize = 60, color = '#e8a5e7');
  }
   if(state == 'tak')
  {
     START_SNOW(frames = 15, count = 20, lifetime = 1, maxSpeed = 4, maxSize = 1000, color = '#30e7ff');
  }
   if(state == 'mar')
  {
     START_SNOW(frames = 15, count = 20, lifetime = 1, maxSpeed = 4, maxSize = 60, color = '#ff0000');
  }
  if(state == 1)
  {
     START_SNOW(frames = 25, count = 30, lifetime = 1, maxSpeed = 4, maxSize = 20, color = '#73C7FF');
  }
  if(state == 0)
  {
     STOP_SNOW();
