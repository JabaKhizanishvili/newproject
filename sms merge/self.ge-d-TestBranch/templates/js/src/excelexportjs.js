        ...
        (function ($) {
          ...
          $.fn.excelexportjs = function (options) {
            ...
            function ConvertFromTable() {
              var $Data = $('#' + $settings.containerid).clone();
              $('img', $Data).remove();
              $('div.my_tooltip span', $Data).remove();
              $('div.my_tip', $Data).contents().unwrap();
              $('a', $Data).contents().unwrap();
...
function exportTableToExcel($Sorce) {
  $($Sorce).excelexportjs({containerid: "exportable", datatype: 'table'});
}