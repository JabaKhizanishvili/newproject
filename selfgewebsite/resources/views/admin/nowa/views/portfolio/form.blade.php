...
@section('content')
    ...
    <!-- /breadcrumb -->
    <input name="old-images[]" id="old_images" hidden disabled value="{{$portfolio->files}}">
    <!-- row -->
    {!! Form::model($portfolio,['url' => $url, 'method' => $method,'files' => true]) !!}
    <div class="row">
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            ...
                                            <div class="form-group d-flex w-50">
                                                ...
                                                value="{{true}}"
                                                @if (isset($portfolio->translate($locale)->visible))
                                                    @if ($portfolio->translate($locale)->visible != null)
                                                    checked
                                                    @endif
                                                @endif
                                                >
